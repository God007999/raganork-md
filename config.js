...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Ruby;GokuBlack;0
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'on',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Ruby",
    BOT_NAME: process.env.BOT_NAME || 'Ruby',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "public" ? 'GokuBlack¹¹ꫂ;Ruby MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
    TAKE_KEY: process.env.TAKE_KEY || '',
    MODE: process.env.MODE || 'public',
    WARN: process.env.WARN || '7',
    ...
    SUDO: process.env.SUDO || "919057434516",
